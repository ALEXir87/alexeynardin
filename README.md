...
Я получил профессиональную переподготовку в области информационных технологий, закончил курсы по специализации "Тестирование программного обеспечения". Я хочу развиваться в области тестирования, так как мне интересно анализировать информацию, логически мыслить и изучать новые технологии. Тестирование помогает улучшить качество программного обеспечения, что для меня, как пользователя, очень важно.
...
<p> Проект №3: "Баг-репорт сайта на разделы: меню на сегодня, наши повара"</p>

<p>Задание:<p>
<ol>
  <li>Провести функциональное тестирование разделов сайта</li>
  <li>Составить баг-репорт на разделы сайта : "меню на сегодня" и "наши повара"</li>
</ol>
...
* Протестировал разделы сайта и составил 4 баг-репорта
* В разделе "меню на сегодня" 2 баг-репорта с приоритетом - High 
* В разделе "наши повара" 2 баг-репорта c приоритетом - Low 

<br>

<p> Проект №4: "Работа с реляционной базой данных"</p>

<p>Задание:<p>
<ol>
  <li>Выполнить выборку различных типов данных хранящихся в таблице</li>
  <li>Выполнить различные способы связывания между собой таблиц</li>
</ol>
...
* Выполнил выборку типов данных из таблиц с помощью операторов SQL 
* Выполнил объединение требуемых типов данных с помощью операторов SQL
...
<p> Проект №6: "Декомпозиция требований, карта mind mapping для страницы оплаты товара"</p>

<p>Задание:<p>
<ol>
  <li>Структурировать и визуально отобразить требования</li>
</ol>
...
* Для эффективного структурирования требований визуально отобразил их в виде карты "mind mapping"
...
<p> Проект №8: "Создание HTML-файла с использованием cтилей СSS"</p>
...
<ol>
  ...
  <li>Заблокировать сетевой запрос логотипа сайта Wildberries.ru</li>
</ol>
...
<p> Проект №10: "Работа со сниффером сетевого трафика (Fiddler Classic)"</p>

<p>Задание:<p>
<ol>
  <li>Сконструировать запрос (request): товары с экрана «Главная» сайта Юла.ru</li>
  <li>Отобразить полученную информацию</li>
</ol>

> <a href="https://youla.ru/">Ссылка на сайт</a>

> <a href="https://drive.google.com/drive/folders/1lfDOVGd5w3Pz-fijIazS5ONm4amP0E-Y?usp=sharing">Ссылка на страницу (конструирование запроса)</a>

<p>Итоги:<p> 

* Создал вручную запрос - товары с экрана «Главная» сайта Юла (http://api.youla.io/api/v1/products)
* Данные по запросу (request) и ответу (response) успешно получены
