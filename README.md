...
* Составлено 9 тест-кейсов
* Подготовлены тестовые условия для проверки поведения системы на запрос пользователя при оформлении web-заказа
...
* После проведённого тестирования разделов web-сайта составлено 4 баг-репорта
...
<p>Задание:<p>
<ol>
  <li>Выборка типов объектов хранящихся в таблице, используя  команды SQL</li>
  <li>Применение различных способов связывания между собой таблиц</li>
</ol>
...
* Произведена требуемая выборка типов данных из таблиц с помощью оператора запроса SELECT 
* Произведено объединение нескольких типов данных с помощью различных операторов JOIN
