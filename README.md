...
Я получил профессиональную переподготовку в области информационных технологий, закончил курсы по специализации "Тестирование программного обеспечения". Мне интересно развиваться в области тестирования, т. к. нравится анализировать 
информацию и логически мыслить, искать причинно-следственные связи, а также изучать новые технологии. Тестирование помогает улучшить качество программного обеспечения, что для меня, как пользователя, очень важно
...
<p> Проект №11: "Работа с кодом на C#"</p>

<p>Задание:<p>
<ol>
  <li>Написать программу вычисления функции Аккермана с помощью рекурсии</li>
</ol>

> <a href="https://drive.google.com/drive/folders/1U2GkSrutpx9EaPSM7k5CYnyPqf4Hqh41?usp=sharing">Ссылка на страницу</a>

<p>Итоги:<p> 

* Написал программу вычисления функции Аккермана с помощью рекурсии, для проверки программы использовал два неотрицательных целых числа в качестве входных параметров
